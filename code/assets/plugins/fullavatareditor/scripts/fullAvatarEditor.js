function fullAvatarEditor() {
    ...
    var file = 'http://assets.shfwzx.muqee.com/plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文件的路径
    var version = "10.1.0";						//播放该flash所需的最低版本
    var expressInstall = 'http://assets.shfwzx.muqee.com/plugins/fullavatareditor/expressInstall.swf';			//expressInstall.swf的路径
