...
$db ['cloud'] ['hostname'] = 'localhost';
$db ['cloud'] ['username'] = 'admin';
$db ['cloud'] ['password'] = 'love1234567890link';
$db ['cloud'] ['database'] = 'cn_kys_dangerous';
...
//$db ['cloud'] ['password'] = 'root';
//$db ['cloud'] ['database'] = 'com_ailht';
//$db ['cloud'] ['dbdriver'] = 'mysql';
//$db ['cloud'] ['dbprefix'] = 'lht_';
//$db ['cloud'] ['pconnect'] = FALSE;
//$db ['cloud'] ['db_debug'] = TRUE;
//$db ['cloud'] ['cache_on'] = FALSE;
//$db ['cloud'] ['cachedir'] = '';
