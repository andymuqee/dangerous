...
/**
 * Apartment_Matter_Model
 *
 * @author andywu
 * @version $Id$
 */
class Apartment_Matter_Model extends MQ_Model
{
    /**
     *待办事项ID
     * @var int
    ...
    public function __construct($arr = array())
    {
        ...
        $this->_table = "apartment_matters";
        $this->_key = "matter_id";
        $this->_name = "matter_id";
        //{models}
    }
...
/* End of file apartment_matter_model.php */
/* Location: ./application/models/apartment_matter_model.php */