...
/**
 * Kitchen_Warehouse_Model
 *
 * @author andywu
 * @version $Id$
 */
class Kitchen_Warehouse_Model extends MQ_Model
{
    /**
     *
     * @var int
    ...
    public function __construct($arr = array())
    {
        ...
        $this->_table = "kitchen_warehouses";
        $this->_key = "warehouse_id";
        $this->_name = "warehouse_id";
        //{models}
    }
...
/* End of file kitchen_warehouse_model.php */
/* Location: ./application/models/kitchen_warehouse_model.php */