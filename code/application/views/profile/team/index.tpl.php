...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            ...
            <a id="frmBatch" href="javascript:void(0);" class="btn btn-primary" data-url="/profile/team/delete_batch"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-footer">
                ...
                <input id="team_id" type="hidden" value=""/>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        MQC.Dialog.save('myModal', 'btnSave', '/profile/team/save?ajax=true', fields);

        $('#myModal').on('show.bs.modal', function (e) {
            o = $(e.relatedTarget);
            if (o.data('id') > 0) {
                $('#team_id').val(o.data('id'));
                MQC.Dialog.data('/profile/team/detail?ajax=true&team_id=' + o.data('id'), fields);
            }
        });
