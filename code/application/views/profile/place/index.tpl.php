...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            ...
            <a id="frmBatch" href="javascript:void(0);" class="btn btn-primary"
               data-url="/profile/place/delete_batch"><i class="fa fa-trash"></i> 批量删除</a>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr index="<?php e($i++); ?>">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:MQC.Dialog.alertUrl('是否删除该发现地点','/profile/place/delete?ajax=true&place_id=<?php e($v->place_id); ?>');">删除</a>
...
<script>
    $(document).ready(function () {
        ...
        MQC.Dialog.save('myModal', 'btnSave', '/profile/place/save?ajax=true', fields);

        $('#myModal').on('show.bs.modal', function (e) {
            o = $(e.relatedTarget);
            if (o.data('id') > 0) {
                $('#place_id').val(o.data('id'));
                MQC.Dialog.data('/profile/place/detail?ajax=true&place_id=' + o.data('id'), fields);
            }
        });
