                        ...
                        <?php foreach ($data as $d):
                            ...
                            if (count($f)):
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php e($f->title); ?>：</label>
                                    <div class="col-sm-9">
                                        <?php if ($f->type == 'text' OR $f->type == 'hidden'): ?>
                                            <input type="<?php e($f->type); ?>" id="<?php e($d['COLUMN_NAME']); ?>"
                                                   name="<?php e($d['COLUMN_NAME']); ?>" class="form-control"
                                                   placeholder="请输入<?php e($f->title); ?>"
                                                   value="<?php e('<?php e($' . $d['COLUMN_NAME'] . ');?>'); ?>"/>
                                            <span class="help-block m-b-none"></span>
                                        <?php endif; ?>
                                        <?php if ($f->type == 'textarea'): ?>
                                            <textarea id="<?php e($d['COLUMN_NAME']); ?>"
                                                      name="<?php e($d['COLUMN_NAME']); ?>" class="form-control"
                                                      placeholder="请输入<?php e($f->title); ?>"></textarea>
                                            <span class="help-block m-b-none"></span>
                                        <?php endif; ?>
                                        <?php if ($f->type == 'select'): ?>
                                            <select id="<?php e($d['COLUMN_NAME']); ?>"
                                                    name="<?php e($d['COLUMN_NAME']); ?>">
                                                <option></option>
                                            </select>
                                            <span class="help-block m-b-none"></span>
                                        <?php endif; ?>
                                        <?php if ($f->type == 'radio'):
                                            foreach ($f->option as $d):
                                                ...
                                                <div class="checkbox checkbox-inline">
                                                    <input type="radio" id="<?php e($d['COLUMN_NAME']); ?>"
                                                           name="<?php e($d['COLUMN_NAME']); ?>"
                                                           value="<?php e($d->v); ?>">
                                        ...
                                        <?php if ($f->type == 'checkbox'):
                                            foreach ($f->option as $d):?>
                                                <div class="checkbox checkbox-inline">
                                                    <input type="checkbox" id="<?php e($d['COLUMN_NAME']); ?>"
                                                           name="<?php e($d['COLUMN_NAME']); ?>"
                                                           value="<?php e($d->v); ?>">
                                                    <label for="inlineCheckbox1"> <?php e($d->n); ?> </label>
                                                </div>
