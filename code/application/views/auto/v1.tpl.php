...
<form id="form1" name="form1" method="post"
      action="/auto/mqmake/v2">
    <div>
        <h1>建立视图第一步</h1>
        <div>
            <label for="class_name">视图ID：</label>
            <input type="text" id="class_id" name="class_id" value=""/>
            <label for="class_name">视图名：</label>
            <input type="text" id="class_name" name="class_name" value=""/>
            <label for="class_name">视图文件名：</label>
            <input type="text" id="class_file" name="class_file" value=""/>
