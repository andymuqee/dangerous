...
<head>
    ...
    <title><?php e('<?php e($page_title); ?>'); ?> - <?php e('<?php e($page_subtitle); ?>'); ?></title>
    ...
    <div class="row">
        <div class="col-sm-8 animated fadeInRight">
            <div class="mail-box-header">
                ...
                <h2><?php e('<?php e($page_subtitle);?>'); ?></h2>
            </div>
            <div class="mail-box">
                <div class="mail-body">
                    <form class="form-horizontal" method="post" action="/<?php e($file); ?>/save" id="myForm">
...
<script>
    ...
    ,
        ...
        messages: {
            ...
            :
                icon + "输入必须<?php e($f->range[0]);?>-<?php e($f->range[1]);?>个字符之间"<?php endif;?>,
            }
        ,
            <?php endforeach;?>
        }
